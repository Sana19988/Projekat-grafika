...
private:
    void makeAnimal(){
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-33.3f, -5.0f, 0.0f));
    ...
    void makeDeva(){
       ...
       //provera
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-7.3f, -5.0f, 0.0f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.1f));
    }
    void makeHuman(){
    ...
    void makeNaraka(){
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(21.3f, -5.0f, 0.0f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.1f));
    }
    void makePreta(){
